...
const socialLinks = [
  { href: 'https://github.com/huzaifawaleed', icon: Code, label: 'GitHub' },
  { href: 'https://linkedin.com/in/huzaifa-waleed', icon: Briefcase, label: 'LinkedIn' },
  { href: 'https://wa.me/60116419627', icon: MessageCircle, label: 'WhatsApp' },
  { href: 'mailto:huzaifainaam225@gmail.com', icon: Mail, label: 'Email' },
]
